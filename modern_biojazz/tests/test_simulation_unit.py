...
from modern_biojazz.simulation import FitnessEvaluator, LocalCatalystEngine, UltrasensitiveFitnessEvaluator, SimulationConfig
...
def test_fitness_evaluator_accepts_backend_network(seed_network):
    ...
    score = evaluator.score(
        ...
        config=SimulationConfig(t_end=5.0, dt=1.0)
    )
    assert score >= 0.0
